                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="flat-red" type="radio" id="blog_status" name="blog_status" value="1" checked>
                                <label for="blog_status">
                                    Aktif
                                </label>
                                <input class="flat-red"  type="radio" id="blog_status1" name="blog_status" value="0" >
